...
public class CharacterManagerViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public CharacterManagerViewPagerAdapter(Context context, FragmentManager fm){
